...
const MODULOS_DIRECAO = ['diretor', 'metas', 'seguranca', 'empresa', 'financeiro', 'fiscal', 'central-ia', 'central-bo', 'tarefas', 'simulador', 'radar-mercado', 'laboratorio-oportunidades', 'integracoes', 'integracao', 'configuracoes'];
